...
public class AccountController {
  ...
  public ResponseEntity<TransactionDto> createTransaction(@PathVariable Long id,
    ...
    if (dto.cpf() != null) {
      personService.getByCpf(dto.cpf());
      Account recebedor = personService.getByCpf(dto.cpf()).getAccount();
      transaction.setRecebedor(recebedor);
    }
    Transaction created = accountService.createTransaction(id, transaction);
